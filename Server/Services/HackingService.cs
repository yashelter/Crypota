...
namespace Server.Services
{
    ...
    {
        public readonly List<Subscriber> Subscribers = new List<Subscriber>(2);
        public readonly CancellationTokenSource SessionCts = new CancellationTokenSource();
    }

    public sealed class SessionStore
    {
        public readonly ConcurrentDictionary<string, ChatSession> Data = new ConcurrentDictionary<string, ChatSession>();
    }
    ...
    {
        public readonly ConcurrentDictionary<string, PendingDh> Data = new ConcurrentDictionary<string, PendingDh>();
    }
