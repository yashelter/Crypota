...
{
    public (BigInteger e, BigInteger d, BigInteger n) KeyPair { get; set; }
    ...
    public class RsaKeyGen
    {
        ...
        private BigInteger GeneratePrimaryNumber()
        {
            ...
            do 
            {
               ...
               // if (setPreLastAsZero)
               // {
                //    bytes[^1] &= (byte) (~(1 << (bits - 1))); // Fermat attack
                //}
        ...
        public (BigInteger p, BigInteger q, BigInteger N) GenerateKeyPair()
        {
            BigInteger p, q, N, phi, d = BigInteger.Zero, y = BigInteger.Zero;
